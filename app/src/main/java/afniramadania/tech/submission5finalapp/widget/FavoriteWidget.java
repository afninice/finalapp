...
public class FavoriteWidget extends AppWidgetProvider {
    ...
    public static final String EXTRA_ITEM = "afniramadania.tach.submission5finalapp.EXTRA_ITEM";
    private static final String REFRESH_ACTION = "afniramadania.tach.submission5finalapp.appwidget.action.REFRESH";
    private static final String TOAST_ACTION = "afniramadania.tach.submission5finalapp.TOAST_ACTION";
    ...
    private static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.activity_favorite_widget);
